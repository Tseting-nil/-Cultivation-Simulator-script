...
local units = {"Sec kills", "Min kills", "Hour kills", "Day kills"} -- 切換單位的選項
...
local function calculateKPS()
    ...
    if currentUnitIndex == 1 then
        ...
        if kpsDisplay >= 10000000 then
            ...
            unitLabel = string.format("%d (M)kills/sec", kpsDisplay) -- 顯示為 "數字 M 秒擊殺"
        elseif kpsDisplay >= 10000 then
            kpsDisplay = math.floor(kpsDisplay / 1000)  -- K
            unitLabel = string.format("%d (k)kills/sec", kpsDisplay) -- 顯示為 "數字 K 秒擊殺"
        else
            unitLabel = string.format("%d kills/sec", kpsDisplay) -- 顯示為 "數字 秒擊殺"
        end
    elseif currentUnitIndex == 2 then
        ...
        if kpsDisplay >= 10000000 then
            kpsDisplay = math.floor(kpsDisplay / 1000000)  -- M
            unitLabel = string.format("%d (M)kills/min", kpsDisplay) -- 顯示為 "數字 M 分鐘擊殺"
        elseif kpsDisplay >= 10000 then
            kpsDisplay = math.floor(kpsDisplay / 1000)  -- K
            unitLabel = string.format("%d (k)kills/min", kpsDisplay) -- 顯示為 "數字 K 分鐘擊殺"
        else
            unitLabel = string.format("%d kills/min", kpsDisplay) -- 顯示為 "數字 分鐘擊殺"            
        end
    elseif currentUnitIndex == 3 then
        ...
        if kpsDisplay >= 10000000 then
            kpsDisplay = math.floor(kpsDisplay / 1000000)  -- M
            unitLabel = string.format("%d (M)kills/hour", kpsDisplay) -- 顯示為 "數字 M 小時擊殺"
        elseif kpsDisplay >= 10000 then
            kpsDisplay = math.floor(kpsDisplay / 1000)  -- K
            unitLabel = string.format("%d (k)kills/hour", kpsDisplay) -- 顯示為 "數字 K 小時擊殺"
        else
            unitLabel = string.format("%d kills/hour", kpsDisplay) -- 顯示為 "數字 小時擊殺"
        end
    elseif currentUnitIndex == 4 then
        ...
        if kpsDisplay >= 10000000 then
            kpsDisplay = math.floor(kpsDisplay / 1000000)  -- M
            unitLabel = string.format("%d (M)kills/day", kpsDisplay) -- 顯示為 "數字 M 天擊殺"
        elseif kpsDisplay >= 10000 then
            kpsDisplay = math.floor(kpsDisplay / 1000)  -- K
            unitLabel = string.format("%d (k)kills/day", kpsDisplay) -- 顯示為 "數字 K 天擊殺"
        else
            unitLabel = string.format("%d kills/day", kpsDisplay) -- 顯示為 "數字 天擊殺"
        end
    else
        unitLabel = string.format("%d kills/sec", kpsDisplay) -- 預設顯示為 "數字 秒擊殺"
    end
